...
#define LEDa_ON      digitalLow(GPIO_LED,GPIO_Pin_LEDa)
#define LEDb_ON      digitalLow(GPIO_LED,GPIO_Pin_LEDb)

#define LEDa_OFF     digitalHigh(GPIO_LED,GPIO_Pin_LEDa)
#define LEDb_OFF     digitalHigh(GPIO_LED,GPIO_Pin_LEDb)
